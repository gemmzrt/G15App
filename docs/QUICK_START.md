...
## Paso 4: Configurar Base de Datos y Storage

📖 **Sigue la guía completa**: `SUPABASE_SETUP.md`

O la versión rápida:

1. En Supabase, ve a **SQL Editor**
2. Abre el archivo `migrations.sql` de este proyecto
3. Copia TODO el contenido y pégalo en SQL Editor
4. Click en **RUN**
5. Ve a **Storage** y crea dos buckets:
   - `avatars` (público)
   - `user_photos` (público)

✅ Si ves "Migration completed successfully!", continúa al siguiente paso.
...
## Paso 7: Convertirte en Admin (Opcional)
